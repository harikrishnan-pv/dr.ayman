                ...
                <div className="flex items-center">
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                        ...
                        <div className="text-sm pt-3 flex items-center sm:pt-0">
                            <Link className="px-5 p-2 hover:shadow-lg transition ease-in-out duration-500 font-bold text-cyan-500" to="/en">
                                English
                            </Link>
                            <Link to="/" className="px-5 p-2 hover:shadow-lg transition ease-in-out duration-500">
                                عربي
                            </Link>
                        </div>
                    </div>
                ...
                <div className="bg-slate-50 py-10">
                    <div className="grid md:grid-cols-2 max-w-6xl mx-auto">
                        ...
                        <div className="px-10 flex flex-col justify-center items-end">
                            ...
                            <a href="https://goo.gl/maps/9kJUcRbWDM5XMiYDA">
                                <div className="text-right mt-5">
                                    White Wing Dental Medical Center
                                </div>
                            </a>
                        </div>
